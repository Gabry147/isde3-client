...
public interface People {
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "updateMeasure", targetNamespace = "http://soap.assignment.introsde/", className = "introsde.assignment.soap.UpdateMeasure")
    @ResponseWrapper(localName = "updateMeasureResponse", targetNamespace = "http://soap.assignment.introsde/", className = "introsde.assignment.soap.UpdateMeasureResponse")
    @Action(input = "http://soap.assignment.introsde/People/updateMeasureRequest", output = "http://soap.assignment.introsde/People/updateMeasureResponse")
    ...
    @RequestWrapper(localName = "readMeasureHistory", targetNamespace = "http://soap.assignment.introsde/", className = "introsde.assignment.soap.ReadMeasureHistory")
    @ResponseWrapper(localName = "readMeasureHistoryResponse", targetNamespace = "http://soap.assignment.introsde/", className = "introsde.assignment.soap.ReadMeasureHistoryResponse")
    @Action(input = "http://soap.assignment.introsde/People/readMeasureHistoryRequest", output = "http://soap.assignment.introsde/People/readMeasureHistoryResponse")
    public List<Measure> readMeasureHistory(
        @WebParam(name = "personId", targetNamespace = "")
        Long personId,
        @WebParam(name = "measureType", targetNamespace = "")
        String measureType);
