 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://soap.assignment.introsde/", wsdlLocation = "http://169.254.157.170:6902/ws/people?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://169.254.157.170:6902/ws/people?wsdl");
    ...
    public People getPeopleImplementationPort() {
        return super.getPort(new QName("http://soap.assignment.introsde/", "PeopleImplementationPort"), People.class);
    }
    ...
    public People getPeopleImplementationPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.assignment.introsde/", "PeopleImplementationPort"), People.class, features);
    }
